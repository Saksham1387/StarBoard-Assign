        ...
        {projectedFinancialMetrics && (
          <Card className="p-4 h-full w-full flex flex-col">
            <div className="flex items-center justify-between mb-4">
              ...
              {projectedFinancialMetrics.source && (
                <SourceLink 
                  source={projectedFinancialMetrics.source}
            ...
            <div className="space-y-4 flex-grow">
              {isValidValue(projectedFinancialMetrics.IRR) && (
                <div>
                  ...
                  <p className="text-xl font-bold">
                    {projectedFinancialMetrics.IRR}
                  </p>
                </div>
              )}

              {isValidValue(projectedFinancialMetrics.equityMultiple) && (
                <div>
                  <div className="flex items-center text-xs text-gray-500 mb-1">
                  ...
                  <p className="text-xl font-bold">
                    {projectedFinancialMetrics.equityMultiple}
                  </p>
                </div>
              )}

              {isValidValue(projectedFinancialMetrics.returnOnEquity) && (
                <div>
                  <div className="flex items-center text-xs text-gray-500 mb-1">
                  ...
                  <p className="text-xl font-bold">
                    {projectedFinancialMetrics.returnOnEquity}
                  </p>
                </div>
              )}

              {isValidValue(projectedFinancialMetrics.returnOnCost) && (
                <div>
                  <div className="flex items-center text-xs text-gray-500 mb-1">
                  ...
                  <p className="text-xl font-bold">
                    {projectedFinancialMetrics.returnOnCost}
                  </p>
                </div>
              )}
            </div>
