...
<SYSTEM_CONSTRAINTS>
   ...
   CRITICAL: Do NOT omit any fields from the schema - all fields must be present.
   CRITICAL: Return ONLY the JSON object - no additional text, explanations, or markdown.
   CRITICAL: In start_position and end_position, use the character index of the text in the PDF document.
   CRITICAL: The start_position and end_position should be exact.
</SYSTEM_CONSTRAINTS>
...

{
  "dealOverview": {
    "source": {
      ...
      "text_in_the_pdf": "N/A or exact text from PDF as it appears return only the first few words of the text for context"
    },
    "propertyName": "N/A or extracted value",
    "location": "N/A or extracted value",
    "dateUploaded": "N/A or extracted value",
